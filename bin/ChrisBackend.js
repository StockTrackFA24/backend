...
async function main(){
     ...
     */
    const uri = "mongodb+srv://chrisdwoodard:<Password>@testcluster.65jxk.mongodb.net/?retryWrites=true&w=majority&appName=TestCluster"
    ...
    try {
        ...
        await reomveItem(client, "43PVLBIA")
...
async function reomveItem(client, removeCatalog){
